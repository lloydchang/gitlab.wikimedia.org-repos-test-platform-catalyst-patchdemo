...
ALTER TABLE `wikis`
    ADD COLUMN IF NOT EXISTS `catalystId` SMALLINT UNSIGNED NULL DEFAULT NULL AFTER `backend`;

ALTER TABLE `wikis`
    ADD COLUMN IF NOT EXISTS `keepWiki` BIT NOT NULL DEFAULT 1 AFTER `created`;
